...
import org.ournet.R;
import org.ournet.data.SpacePhoto;

//this class is adapter of recycler view and manage the event on photos
public class SpaceGalleryActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.recycler_view_galery);
    ...
    //this internal class manage the galery of photos
    private class ImageGalleryAdapter extends RecyclerView.Adapter<ImageGalleryAdapter.MyViewHolder>  {
        ...
        // here is when glide work getting images from a uri and show it to user while he slide through screen
        @Override
